  ...
  return (
    <footer className="border-t border-neutral-200 mt-16 px-5 md:px-16 py-10 md:py-16">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <Link href={"/"} className="text-3xl">
              <span className="text-rose-600">DIVER</span>HOOD
            </Link>
            <p className="max-w-xs mt-4 text-sm">
              Furniture shopping starts with visualization, not keywords.
            </p>
        ...
        <p className="mt-8 text-xs">© 2024 Diverhood - All rights reserved</p>
      </div>
    </footer>
  );
};
